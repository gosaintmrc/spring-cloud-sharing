 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://impl.service.gosiant.com/", wsdlLocation = "http://localhost:8088/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://impl.service.gosiant.com/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/calculator?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://impl.service.gosiant.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.gosiant.com/", "CalculatorImplPort"), Calculator.class, features);
    }
